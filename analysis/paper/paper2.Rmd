...
XRF.csv <-
  read.csv2("C:/Users/sjola/Documents/VERSION CONTROL/quantifying-quartzite/analysis/data/raw_data/XRF/XRF_quantitative.csv", sep = ";", dec = ".", header = TRUE, check.names = FALSE, na = c("","NA","NULL"))

#Import nir data, set empty fields to NA
nir.csv <-
  read.csv2("C:/Users/sjola/Documents/VERSION CONTROL/quantifying-quartzite/analysis/data/derived_data/NIR_master_averaged_20220119.csv", sep = ";", dec = ",", header = TRUE, check.names = FALSE, na = c("","NA","NULL",NULL))
...
Points2$parish <- 
  factor(Points2$parish, levels = c("Bjurholm","Bureå","Burträsk", "Bygdeå", "Degerfors", "Dorotea", "Lycksele", "Norsjö", "Skellefteå", "Sorsele", "Stensele", "Tärna", "Umeå", "Vännäs", "Vilhelmina", "Åsele"))
```
...
#perform PCA with SNV normalization and mean-center on the 
raman.pca <-
...
basic_plot2 <-
  fviz_pca_ind(raman.pca, axes = c(2,3), label="none")
...
raman.pc4lab <- paste0("PC3 (",as.character(raman.pc4var),"%)")
