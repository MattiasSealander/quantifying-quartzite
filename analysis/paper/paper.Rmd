...
It is well-known that NIRS is less effective on translucent material, such as a pure quartz crystal, as the absence of impurities in the material will result in little to no reflection/absorbance of light [@hunt77]. Similarly it can be difficult to work with dark materials as most of the light produced by the instrument will be absorbed, thus obscuring any potential features in the spectra. This effect can be seen in figure \@ref(fig:nir-spectra-summary) which shows a summary of the centered NIR spectra by color group. The dark group generally features less distinct peaks than the material with a lighter hue. This is not to say that all spectra collected on dark quartzite features less information, but any model including them will likely affect the clustering of the dataset as a whole. Transforming the data collected on the dark samples using derivatives can help in the evaluation of the spectra. Savitzky-Golay filtering (SG) is a smoothing technique that has been widely applied in spectroscopy (although there has been recent suggestions for adaptions, see [@schmid_etal22]). SG filters out broad spectral features, which is beneficial in NIRS, but may also amplify any existing noise in the spectra [@chryssikos_gates17 pp.78-81; @mark_workman21 pp. 351-397]. Comparing one of the centered spectra from the dark group to its derivative counterpart it becomes clear that there indeed are significant peaks that may be of relevance to the characterization of the material, despite the high absorbance (fig. \@ref(fig:nir-savitzky-transform)). Filtering out those spectra that feature no discernible peaks or mainly noise leaves `r length(spec.d)` samples in the dark group. There is still, however, a significant difference between the dark and light group, as can be seen by comparing fig. \@ref(fig:nir-spectra-summary) and fig. \@ref(fig:nir-savitzky-transform):A. 
