...
```{r raman-spectra, fig.width=20, fig.height=8, fig.cap="Spectra of raman measurements sampled on a dark quartzite featuring both the *quartz peak* at 460 cm-1, as well as the *graphite peaks* at 1 287  cm-1 (D band) and 1 598 cm-1 (G band)"}
