...
#Import xrf data
XRF.csv <-
  read.csv2("./analysis/data/raw_data/XRF/XRF_quantitative.csv", sep = ";", dec = ".", header = TRUE, na = c("","NA","NULL"))
...
# remove inital 'X' from element names, which was introduced in initial import to R
loadings$Element <- substring(loadings$Element, 2)
