...
nir.csv <-
  read.csv2("./analysis/data/derived_data/NIR_master_averaged_20210914.csv", sep = ";", dec = ",", header = TRUE, check.names = FALSE, na = c("","NA","NULL",NULL))
