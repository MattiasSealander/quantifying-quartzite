...
All Raman spectra were baseline corrected using modified polynomial fitting in R (R Core Team, 2017) using the ChemoSpec package [@hanson16]. The spectra were then mean-centred and normalized using Standard Normal Variate (Shaver, 2001: 284-285) in the Prediktera Evince software.
