...
```{r raman-average, fig.width=15, fig.height=5, fig.fullwidth=TRUE, fig.cap="Average spectra of raman measurements sampled on grey-to-dark quartzite featuring both the *quartz peak* at 460 cm-1, as well as the *graphite peaks* around 1 300 cm-1 (D band) and 1 600 cm-1 (G band)"}
knitr::include_graphics('C:/Users/masj0062/Documents/DOKTORANDSPROJEKT/VERSION CONTROL/MethodPaper/analysis/figures/raman_average_spectra_dark_20210823.png')
```
