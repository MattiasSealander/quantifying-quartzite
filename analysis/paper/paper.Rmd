...
raman.csv <-
  read.csv2("C:/Users/sjola/Documents/VERSION CONTROL/quantifying-quartzite/analysis/data/derived_data/raman_baseline_corrected_20220119.csv", sep = ";", dec = ",", header = TRUE, check.names = FALSE, na = c("","NA","NULL",NULL))
