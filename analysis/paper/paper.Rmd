...
 \linebreak
 ...
 The structures seen in the NIRS PCA are 

However, a large group of the material that feature different hues of grey, does not conform as easily. In each of the PCA models there is a *greyish* middle of samples that fall in between the extremes of the observable trends that make classification difficult. 
...
The results demonstrate clearly that all three instrumentations are capable of characterizing some aspect of the quartz and quartzite, however, taken on their own they lack the resolution needed to provide a detailed enough fingerprint on their own based solely on surface measurements. Taken together, however, they do provide a more in-depth understanding of the characteristic and structure of the material. 

The most easily recognizable megascopic feature of the material is its colour, and this has been one of the main means of describing quartzite in Northern Sweden (e.g. [@forsberg85], []). The overall structure in the spectroscopic results for each of the instrumentations, and especially the NIRS, groups samples of similar color (given as munsell hue) together, however, the presence of samples that break these trends demonstrate the presence of structural and compositional features that do not necessarily align with the perceived color of a material.  

In the case of the raman data the PCA is somewhat lacking in exploratory and descriptive power. Apart from the 700 cm-1 - 800 cm-1 band peaks the major features in the data are explained by PC 1. Intensity in raman spectroscopy is not a direct quantitative indicator, thus making it difficult to group materials along the PC 1, apart from presence/absence of the *graphite peaks*.     

The metamorphic background of quartzite makes it a complex rock for characterization, but that is not to say that there aren't potential markers that may be used for fingerprinting. The presence of sp^2^-C and AlOH peaks are worthwhile to follow up.
