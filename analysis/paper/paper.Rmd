...
In the current study a dataset of quartz and quartzite artefacts from museum collections in Västerbotten, Sweden, have been analysed using the three above mentioned spectroscopic instrumentations (NIRS, Raman, XRF). The aim is to evaluate their viability for fingerprinting quartz and quartzite material in the North Swedish region, where there currently is a lack of reference material as well as a complex geological setting. This will be achieved via Principal Component Analysis (PCA), where the observed groupings of the material in the model will be related to their spectral features. 
 \linebreak
